...
const ProductCard: FC<Product> = (product) => {
    ...
    return (
        ...
        <div className=' p-3 rounded-md shadow-[0_8px_30px_rgb(0,0,0,0.12)] flex flex-col gap-3 '>
            ...
            <button className='max-w-sm w-fit px-3 py-2 rounded-sm  flex gap-2 items-center bg-blue-200 hover:cursor-pointer hover:bg-blue-300 transition-all' onClick={handleAddToCart} >
